...
const MEMBERS = [
  { name: "Anichitoaie Arun", grade: "Clasa XI", department: "Programming" },
  { name: "Conț Alexandru", grade: "Clasa IX", department: "Programming" },
  { name: "Ciorbă Darius", grade: "Clasa XI", department: "Mecanica" },
  { name: "Berinde Călin", grade: "Clasa X", department: "Mecanica" },
  { name: "Galațan Adelin", grade: "Clasa IX", department: "Mecanica" },
  { name: "Tărnar Marian", grade: "Clasa X", department: "Mecanica" },
  { name: "Tărnar Denis", grade: "Clasa XI", department: "3D Design" },
  { name: "Danci Rareș", grade: "Clasa X", department: "3D Design" },
  { name: "Oșan Emanuel", grade: "Clasa IX", department: "3D Design" },
  { name: "Solomon Andreea", grade: "Clasa X", department: "Public Relations" },
  { name: "Bătărcean Paula", grade: "Clasa X", department: "Public Relations" },
  { name: "Balta Mayer", grade: "Clasa XI", department: "Public Relations" },
];
const MENTORS = [
...
const VOLUNTEERS = [
  { name: "Bud Tudor", role: "" },
  { name: "Lisca David", role: "" },
  { name: "Borzidan Adelin", role: "" },
  { name: "Ciciou Samuel", role: "" },
  { name: "Tontea Gabriela", role: "" },
  { name: "Pocicaischi Ioana", role: "" },
  { name: "Vasile Aaron", role: "" },
  { name: "Solomeș Adrian", role: "" },
  { name: "Radu Patricia", role: "" },
  { name: "Radu Debora", role: "" },
  { name: "Hauși Andra", role: "" }
];
